...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => RunningAnalysisWidget(
        ...
        FFRoute(
          ...
          builder: (context, params) => AdvancedRunningMetricsWidget(
        ...
        FFRoute(
          ...
          builder: (context, params) => TripleJumpAnalysisWidget(
            activityDoc: params.getParam(
              'activityDoc',
              ParamType.Document,
            ),
        ...
        FFRoute(
          ...
          builder: (context, params) => LongJumpAnalysisWidget(
            activityDoc: params.getParam(
              'activityDoc',
              ParamType.Document,
            ),
        ...
        FFRoute(
          ...
          builder: (context, params) => AdvancedTripleJumpMetricsWidget(
            trippleJumpDataDoc: params.getParam(
              'trippleJumpDataDoc',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          ...
          builder: (context, params) => AdvancedLongJumpMetricsWidget(
            longJumpDataDoc: params.getParam(
              'longJumpDataDoc',
              ParamType.Document,
            ),
          ),
