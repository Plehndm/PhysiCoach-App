...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFF03045E);
  late Color alternate = const Color(0xFFCAF0F8);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xD800E1FF);
  late Color secondaryBackground = const Color(0xF2FFFFFF);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0xFF90B6EF);
  late Color accent3 = const Color(0xFF90E0EF);
